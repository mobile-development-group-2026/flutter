        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              OnboardingField(
                label: 'TITLE',
                hint: 'Comfortable studio near the cathedral',
                icon: Icons.title,
                onChanged: (v) {
                  vm.title = v;
                  vm.notifyListeners();
              ...
              Wrap(
                ...
                children: NewListingViewModel.amenities.map((a) => CustomChip(
                  label: a,
                  selected: vm.selectedAmenities.contains(a),
                  onTap: () => vm.toggleAmenity(a),
                )).toList(),
              ),
              const SizedBox(height: 16),
              ...
              Wrap(
                ...
                children: NewListingViewModel.rules.map((r) => CustomChip(
                  label: r,
                  selected: vm.selectedRules.contains(r),
                  onTap: () => vm.toggleRule(r),
                )).toList(),
              ),
              const SizedBox(height: 16),
              Row(
                children: [
                  ...
                  const Spacer(),
                  Text(
                    '${vm.description.length} / ${NewListingViewModel.descriptionMinChars} min',
                    style: TextStyle(
                      fontSize: 11,
                      fontFamily: 'Sora',
                      color: vm.description.length >= NewListingViewModel.descriptionMinChars
                          ? ExtraAppColors.green400
