          ...
          child: Column(
            ...
            children: [
              ...
              PrefSection(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Row(
                      children: ListingPreferencesViewModel.budgetOptions.map((amount) {
              ...
              PrefSection(
                ...
                title: 'CONTRACT TERM',
                child: Row(
                  children: ListingPreferencesViewModel.leaseOptions.map((months) =>
                    Expanded(
                      child: Padding(
                        padding: const EdgeInsets.only(right: 6),
                        child: CustomChip(
                          ...
                          onTap: () => vm.setLeaseLength(months),
                        ),
                      ),
                    ),
                  ).toList(),
