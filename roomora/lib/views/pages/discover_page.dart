                  ...
                  if (vm.errorMessage != null) {
                    return Center(
                      child: Column(
                        ...
                        children: [
                          Icon(LucideIcons.wifi, color: AppColors.neutral500, size: 40),
          ...
          Stack(
            children: [
              Container(
                ...
                child: Center(
                  child: Icon(LucideIcons.house, size: 48, color: AppColors.purple300),
                ),
              ),
              Positioned(
                top: 12,
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Icon(LucideIcons.heart, size: 20, color: AppColors.neutral400),
                  ],
                ),
                const SizedBox(height: 6),
                Row(
                  children: [
                    Icon(LucideIcons.mapPin, size: 13, color: AppColors.neutral500),
                    const SizedBox(width: 4),
                    Text(
              ...
              children: [
                Row(
                  ...
                  children: [
                    ...
                    Icon(LucideIcons.heart, size: 16, color: AppColors.neutral400),
                  ],
                ),
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          _navItem(icon: LucideIcons.map, label: 'Map'),
